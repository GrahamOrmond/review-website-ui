    ...
    <Router>
      ...
      <div className="app">
        ...
        <Route exact path="/:location?/:brandId?/:productUrl?/submit/:postType?/" component={PostsPage} />
          <Route exact path="/brands/:brandId?/:postsType?/:sort?/:postLink?/:action?"
            component={BrandsPage} />
          <Route exact path="/products/:brandId?/:productUrlId?/:postsType?/:sort?/:postLink?/:action?" 
            component={ProductsPage} />
          <Route exact path="/community/:type?/:sort?/:postLink?/:action?" component={CommunityPage} />
